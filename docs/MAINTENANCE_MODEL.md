...
`growup-maintenance-1.0.0` estimates routine person-hours and labour cost for the woody planting system from year 1 onward. It is not a crop gross-margin model.
...
Each task has an initial and mature coefficient. The transition uses:
...
|---|---|---|---|
| Syntropic | High early selective weeding, biomass and succession work; rapid vegetation-control decline; persistent pruning and biomass work at maturity | Measured agroforestry references | Medium |
