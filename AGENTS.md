...
- The mobile top bar exposes only the brand, hamburger and Ask AF action. Language, tour, information, save state/actions, revision history, exports and authentication belong in the aligned mobile product menu. The succession-year control remains fixed above the mobile workflow navigation, with toasts and onboarding coaches offset above it and sufficient panel padding to reveal the final action.
