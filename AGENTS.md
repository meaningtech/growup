...
- Mobile map controls use a single-row bottom dock above any timeline; coach panels and toasts remain above the safe-area bottom navigation, interactive form controls render at 16 px or larger to prevent iOS focus zoom, and the desktop map/inspector split collapses without horizontal overflow at 820 px and below.
- The compact top bar keeps Ask AF and the hamburger at the far right. Language, tour, information, save state/actions, revision history, exports and authentication belong in the right-aligned product menu. The succession-year control remains fixed above the mobile workflow navigation, with toasts and onboarding coaches offset above it and sufficient panel padding to reveal the final action.
